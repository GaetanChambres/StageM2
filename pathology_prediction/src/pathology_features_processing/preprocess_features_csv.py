...
input1 = './pathology_prediction/data/csv/debug/train_lowlevel.csv'
input2 = './pathology_prediction/data/csv/debug/train_info.csv'
output = './pathology_prediction/data/csv/debug/train_pathologies.csv'
