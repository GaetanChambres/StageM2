'''
Code source from https://github.com/MTG/essentia
Licenced under Affero General Public License
See essentia-licence.txt
'''
...
def parse_descriptors(d, id, include=None, ignore=None):
    results = {}
    results['id'] = id
...
def convert(json_file, include, ignore):
    ...
    id = __get_id__(json_file)

    return parse_descriptors(data, id, include, ignore)
